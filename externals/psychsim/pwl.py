...
def differenceDirectedRow(key1,key2,threshold):
    """
    @return: a plane testing whether the first keyed value is no more than threshold greater than the second
    @rtype: L{KeyedPlane}
    """
    return KeyedPlane(KeyedVector({key1: 1.,key2: -1.}),threshold, -1)
